                                    ...
                                    <div class="fslider" data-pagi="false">
                                        <div class="flexslider">
                                            <div class="slider-wrap">
                                                <div class="slide"><a
                                                        href="{!!asset('media/product/item/'.$item->fileimg)!!}"
                                                        title="{{$item->nama_item}} - Front View"><img
                                                            src="images/shop/dress/3.jpg"
                                ...
                                <div class="card product-meta mb-0">
                                    <div class="card-body">
                                        ...
                                        <span class="tagged_as">Tags: <a href="#" rel="tag">Barena</a>, <a href="#"
                                                rel="tag">Blazers</a>, <a href="#" rel="tag">Tailoring</a>, <a href="#"
