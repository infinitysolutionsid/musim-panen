                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Halo tim CV. Putra Karya Logam
                                                            Sukses,</span></p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">
                                                            Kamu telah menerima permintaan penawaran baru, permintaan
                                                            order yang
                                                            telah sistem terima: <br><br>
                                                            Peminta Penawaran: {{$quot->request_name}} <br>
                                                            Nama bidang usaha (PT/CV/UD): {{$quot->request_company}}
                                                            <br>
                                                            Catatan permintaan penawaran: {!!$quot->messages!!} <br>
                                                            <br>
                                                            <strong>Detail peminta penawaran</strong> <br>
                                                            No HP: {{$quot->phone}} <br>
                                                            Email: {{$quot->email}} <br><br>

                                                            <strong>Data produk yang mau diminta penawaran:</strong><br>
                                                            Nama Item Produk:
                                                            <ol>
                                                                @foreach ($itemId as $idItem)
                                                                <li><strong>{{$idItem->nama_item}}</strong></li>
                                                                @endforeach
                                                            </ol>

                                                            Ayo kita selesaikan Order #{{$quot->id}} dan jangan
                                                            tunda
                                                            tunda lagi!.
                                                        </span>
                                                    </p>
                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style=""><strong>Terima kasih.</strong><br>
                                                            putrakaryalogamsukses.com system <br>
                                                            support@putrakaryalogamsukses.com <br></span></p>
                                                </div>
                                            </div>
                                            <div
                                                style="font-family:Helvetica, sans-serif;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;">
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <small class="text-muted">Anda menerima email ini sebagai
                                                        pemberitahuan
                                                        tentang adanya
                                                        order permintaan baru dalam sistem
                                                        putrakaryalogamsukses.com</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
