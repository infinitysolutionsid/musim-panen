                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    ...
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">
                                                            Kamu telah menerima pesan baru dari halaman
                                                            putrakaryalogamsukses.com/contact-us, berikut detail
                                                            pesannya: <br><br>

                                                            Nama Pengirim: {{$email->name}} <br>
                                                            Email: {{$email->email}} <br>
                                                            No Ponsel: {{$email->nohp}} <br>
                                                            Pesan: {!!$email->message!!} <br>

                                                            Ayo kita respon pesan dari calon customer ini, siapa tau aja
                                                            bisa jadi rezeki :).
                                                        </span>
                                                    </p>
                                                </div>
